...
<div class="container" style="margin-top: 20px">
    ...
    <%--发布商品--%>
    <span id="goods_status" style="display: none">1</span>
    ...
    <div class="row">
        <div class="col-md-2 release_goods list-group">
            ...
            <div class="list-group-item list-group-item-success release_remind">
                <span><br/>已发布 <span id="release_count">${goods_count}</span> 个<br/>最多能发布15个商品</span>
            </div>
        </div>
            ...
            <c:if test="${status != '3'}">
                <form method="post" onsubmit="return false">
                    ...
                    <div class="form-group">
                        ...
                        <div class="div_input_width">
                                <textarea class="form-control" name="release_goods_summary"
                                          ...
                                          onblur="checkGoodsSummary('release_goods_summary',79)"
                                          onfocus="clearRemind()">商品简介,50字以内
                            </textarea>
                        </div>
                    </div>
                    <div class="clear_float"></div>
                    ...
                    <div class="form-group dmt">
                        ...
                        <div class="div_input_width">
                            <input type="text" class="form-control" name="goods_address" id="goods_address"
                                   onblur="checkGoodsAddress('goods_address')">
                        </div>
                    </div>
                    <div class="clear_float"></div>
                    <div class="form-group dmt">
                    ...
                    <div class="form-group dmt">
                        ...
                        <div class="div_space">
                                <textarea name="goods_content" cols="80" rows="16" id="goods_content"
                                          onblur="checkGoodsInfo()">
