 ...
 * on 2015/12/5
 */
public class RequestUrlSecurityImpl implements RequestUrlSecurity {
     ...
     * @throws Exception
     */
    public RequestUrlSecurityImpl(String strKey) throws Exception {
     ...
     * @return 加密后的字符串
     * @throws Exception
     * @see com.schoolexchange.www.interceptor.CommonInterceptor
     */
